    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md glassmorphism rounded-2xl p-8 relative z-10">
        ...
        <div className="text-center mb-8">
          <h2 className="font-serif-authority text-xl text-white mb-2">Bem-vindo</h2>
          <p className="text-brand-bright/60 text-sm">Acesse sua conta para continuar</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-brand-bright/30 bg-black/40 text-brand-bright focus:ring-brand-bright" />
              <span className="text-sm text-gray-400">Lembrar-me</span>
            </label>
            <Link to="/forgot-password" className="text-sm text-brand-bright hover:underline">
              Esqueci a senha
            </Link>
          </div>
        ...
        <p className="text-center text-gray-400 text-sm">
          Não tem uma conta?{' '}
          <Link to="/register" className="text-brand-bright font-semibold hover:underline">
            Cadastre-se
          </Link>
        </p>
      </div>
